...
hi Search          ctermfg=33    ctermbg=234
hi IncSearch       ctermfg=1    ctermbg=15
hi WarningMsg      ctermfg=9    ctermbg=234
hi Question        ctermfg=10   ctermbg=234
"hi Pmenu           ctermfg=2    ctermbg=15
hi Pmenu           ctermbg=233  gui=bold
hi PmenuSel        ctermfg=1    ctermbg=228
